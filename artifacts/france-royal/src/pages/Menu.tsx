...
export default function Menu() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-slate-900 text-slate-50 relative overflow-hidden">
      ...
      <div className="text-center z-10 space-y-6 p-8 max-w-md w-full bg-slate-900/80 backdrop-blur-md rounded-2xl border border-slate-800 shadow-2xl">
        <div className="space-y-3">
          ...
          <p className="text-base text-slate-400 font-medium">
            L&apos;Assemblée Nationale meets the Arena.
          </p>
        </div>

        <div className="space-y-2 text-sm text-slate-300 text-left bg-slate-800/50 p-4 rounded-lg">
          <h3 className="font-bold text-white mb-2 uppercase tracking-wider text-xs">Comment jouer :</h3>
          <ul className="list-disc pl-4 space-y-1.5">
            <li>Cliquez une carte pour la sélectionner, puis cliquez l&apos;arène pour la poser.</li>
            <li>Détruisez la Tour du Roi ennemie pour gagner.</li>
            <li>L&apos;élixir se recharge au fil du temps.</li>
            <li>Chaque personnalité a ses propres pouvoirs absurdes.</li>
          </ul>
        </div>
        ...
        <div className="space-y-3">
          <Link href="/game">
            <Button
              size="lg"
              className="w-full h-14 text-lg font-bold bg-blue-600 hover:bg-blue-700 text-white transition-all transform hover:scale-105"
          ...
          <Link href="/lobby">
            <Button
              size="lg"
              variant="outline"
              className="w-full h-14 text-lg font-bold border-2 border-fuchsia-500 text-fuchsia-300 hover:bg-fuchsia-900/30 hover:scale-105 transition-all"
